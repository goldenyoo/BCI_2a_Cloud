...
for data_label = data_labels
    for m = ms
        ...
        save_file_name = strcat('/Users/goldenyoo/Library/Mobile Documents/com~apple~CloudDocs/BioCAS_prepare/BCIIV_2a_mat/myData/Aug/Calib_data_',data_label ,'_chop_',int2str(m),'.mat')
